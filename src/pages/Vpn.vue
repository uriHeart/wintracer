    ...
    data () {
      ...
      return {
        ...
        columns:  [
            ...
            { title: '사용자 PC 명', field: 'user',colStyle:{width:'10%'}},
            { title: 'VPN ID', field: 'loginId',colStyle:{width:'10%'}},
            { title: 'VPN IP', field: 'destination_ip',colStyle:{width:'15%'}},
            { title: '접속 message', field: 'message',colStyle:{width:'15%'}}
